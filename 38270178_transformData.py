...
with open('38270178_template.csv', 'r') as template_file:
...
with open('mailing_lists/38270178_full.csv', 'w', newline='') as output_file:
    writer = csv.writer(output_file)
    writer.writerow(header)  # Write the header row
    writer.writerow(template_row)  # Write the template row as the header
    writer.writerows(values)

print("Values populated and saved in mailing_lists/38270178_full.csv.")